package com.shaAlgorithmDemo.spring.security.test;
        ...
        this.mockMvc
                .perform(
                        post("/registration")
                                ...
                                .param("email", "info@shaAlgorithmDemo.com")
                                .param("confirmEmail", "info@shaAlgorithmDemo.com")
        ...
        this.mockMvc
                .perform(
                        post("/registration")
                                ...
                                .param("firstName", "Memory")
                                .param("lastName", "Not Found")
                                .param("email", "new@shaAlgorithmDemo.com")
                                .param("confirmEmail", "new@shaAlgorithmDemo.com")
                                .param("password", "password")
        ...
        this.mockMvc
                .perform(
                        post("/registration")
                                ...
                                .param("lastName", "Not Found")
                                .param("email", "new@shaAlgorithmDemo.com")
                                .param("confirmEmail", "different@shaAlgorithmDemo.com")
                                .param("password", "password")
                                .param("confirmPassword", "invalid")
                                .param("terms", "on")
                )
